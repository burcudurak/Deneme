package com.example.burcu.deneme;
...
public class MainActivity extends FragmentActivity {
    ...
    private static String APP_ID = "1605257279727436"; //"Ornek API Uygulama" Facebook uygulamasının APP_ID yazdık
    ...
    public void getProfileInformation() {
        ...
        try {
            ...
            JSONObject profile = Util.parseJson(facebook.request("1409767009343336"));
